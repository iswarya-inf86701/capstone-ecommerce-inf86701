export default async function decorate(block) {
  ...
  container.className = 'product-teaser-container';
  ...
  intro.className = 'product-teaser-intro';
  ...
  shopLink.className = 'product-teaser-shop';
  ...
  productGrid.className = 'product-teaser-grid';
